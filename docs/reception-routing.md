...
The reference implementation in `chef-bot` has no routing rule in `data/knowledge.md`. Its intent-classifier system prompt does distinguish the two modes as follows (kept verbatim as the basis for Leya's classifier):
